...
namespace Hrimsoft.SqlBulk.PostgreSql
{
    ...
    public class PropertyProfile
    {
        ...
        /// <summary>
        /// If true then the value of the property that represents this profile will be updated after insert or update operation
        /// </summary>
        public bool UpdateAfterOperationComplete { get; private set; }
        ...
        {
            this.UpdateAfterOperationComplete = true;
            return this;
        }
