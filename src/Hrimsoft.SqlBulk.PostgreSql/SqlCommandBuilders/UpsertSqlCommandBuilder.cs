...
namespace Hrimsoft.SqlBulk.PostgreSql
{
    ...
    public class UpsertSqlCommandBuilder : IUpsertSqlCommandBuilder
    {
        ...
        public (string Columns, string ReturningClause, string UpsertClause) GenerateClauses([NotNull] EntityProfile entityProfile)
        {
            ...
            var upsertClause = GenerateUpsertClause(entityProfile.UniqueConstraint);
            // TODO: Generate action clause
        ...
        /// <returns></returns>
        public string GenerateUpsertClause([NotNull] EntityUniqueConstraint uniqueConstraintInfo)
        {
