...
namespace Hrimsoft.SqlBulk.PostgreSql.IntegrationTests.BulkInsert
{
    public class BulkInsertIntegrationTests
    {
        ...
        {
            var truncateBulkTestEntity = "truncate \"unit_tests\".\"bulk_test_entity\";";
            ...
            await using var commandSimpleTestEntity = new NpgsqlCommand($"{truncateBulkTestEntity}{resetIdSequenceCmd}", connection);
